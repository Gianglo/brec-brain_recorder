...
import com.brec_project.components.signal.FFT;
import com.brec_project.components.signal.PSDBuffer;
...
public class PSDGraph extends FrameLayout {
    ...
    public void startRecording(String title, String header) {
        dataSource.fileWriter.initFile(title, header);
    ...
    public void stopRecording(String title) {
        ...
        if (dataSource != null && dataSource.fileWriter.isRecording()) {
            dataSource.fileWriter.writeFile(title);
        }
    }
