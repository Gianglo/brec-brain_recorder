    ...
    switch (this.props.connectionStatus) {
      ...
      default:
        return (
          <View style={styles.container}>
            <Text style={styles.noMuses}>Muse non connesso</Text>
        ...
        return (
          <View style={styles.container}>
            <Text style={styles.noMuses}>
                I bluetooth devono essere accesi!
            </Text>
            <WhiteButton onPress={() => this.getAndConnectToDevice()}>
              CERCA
            </WhiteButton>
        ...
        return (
          <View style={styles.container}>
            ...
            <View style={styles.connectingContainer}>
              ...
              <Text style={styles.connecting}>Cercando...</Text>
            </View>
          </View>
        );
        ...
        return (
          <View style={styles.container}>
            <View style={styles.connectingContainer}>
              <ActivityIndicator color={"#94DAFA"} size={"large"} />
              <View>
                <Text style={styles.connecting}>Connessione...</Text>
      ...
      case config.connectionStatus.CONNECTED:
        return (
          <View style={styles.container}>
            <View style={styles.connectingContainer}>
              <Text style={styles.connected}>Connesso</Text>
            </View>
          </View>
        );
    }
